...
def home(request):
    ...
    cat_stone   = Product.objects.filter(is_active=True, show_on_home=True, category__icontains='earring').first()
    cat_wedding = Product.objects.filter(is_active=True, show_on_home=True, category__icontains='ring').first()
