...
def home(request):
    ...
    cat_stone   = Product.objects.filter(id=5).first()
    cat_wedding = Product.objects.filter(id=6).first()
    cat_stud    = Product.objects.filter(id=7).first()
    cat_gold    = Product.objects.filter(id=8).first()
    cat_fine    = Product.objects.filter(id=9).first()
    cat_diamond = Product.objects.filter(id=10).first()
